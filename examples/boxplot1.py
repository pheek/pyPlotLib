...
fig, ax = create_swiss_coordinate_system(0, 40, 0, 6, show_y_axis=False)

# Beispieldaten: Punkte in einer Prüfung
daten_klasse_a = [3, 5, 6, 7, 8, 8, 9, 10, 12, 14]
daten_klasse_b = [5, 8, 9, 9, 10, 10, 11, 12, 13, 15, 39]

# Zwei Boxplots übereinander zeichnen
draw_boxplot(ax, daten_klasse_a, y_position=2, label="Klasse A", color='#3498db')
