#!/usr/bin/python3
# main.py
from bms_graph_lib import bmsw_coordinate_system, draw_bar_chart, save_system
...
fig, ax = bmsw_coordinate_system(0, 6, 0, 5)
...
# 3. Säulen zeichnen
draw_bar_chart(ax, monate_x, werte_y, label="Verkäufe", color='#fabc22')
