...
b.draw_system(0, 20, 0, 6, show_y_axis=False, step_x=5, figsize=(10,3))
...
b.draw_boxplot(daten_klasse_a, y_position=2, label="Klasse A", color='#3498db', axis_label="Noten", height=0.7)
